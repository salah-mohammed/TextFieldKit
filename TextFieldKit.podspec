...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/salah-mohammed/TextFieldKit"
  ...
  s.source       = { :git => "https://github.com/salah-mohammed/TextFieldKit.git", :tag => "#{s.version}",:branch => "master"}
